...
- バージョン：**v0.39.1（versionCode 60）**でクローズドテスト審査中
- クローズドテストは2026-08-19開始（最短9/2まで）。テスターは14アカウントで12名の条件を満たしている
- 次の作業：**v0.39.2（versionCode 61）**——TransferManagerの部分ファイル完了扱いバグ修正＋アプリ名の表記ゆれ修正
